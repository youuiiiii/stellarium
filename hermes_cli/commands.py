...
COMMAND_REGISTRY: list[CommandDef] = [
    ...
    CommandDef("snapshot", "Create or restore state snapshots of Stella config/state", "Session",
    ...
    CommandDef("goal", "Set a standing goal Stella works on across turns until achieved", "Session",
    ...
    CommandDef("wake", "Toggle the 'Hey Stella' wake word listener", "Configuration",
               cli_only=True, args_hint="[on|off|status]", subcommands=("on", "off", "status")),
    CommandDef("busy", "Control how messages behave while Stella is working", "Configuration",
    ...
    CommandDef("update", "Update Stellarium to the latest version", "Info",
               busy_policy="dispatch", desktop="terminal"),
    CommandDef("version", "Show Stellarium version", "Info", aliases=("v",),
