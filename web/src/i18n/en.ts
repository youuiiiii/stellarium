...
export const en: Translations = {
  ...
  status: {
    ...
    restartGatewayConfirmMessage:
      "This restarts the Stellarium gateway process. Connected channels and active sessions will reconnect afterward.",
    ...
    stopped: "Stopped",
    updateHermes: "Update Stellarium",
    updateHermesConfirmMessage:
      "This runs stella update and restarts the gateway when it finishes. Active sessions keep their prompt cache until then.",
    updateHermesConfirmNow: "Update now",
    updateHermesConfirmTitle: "Update Stellarium?",
    updatingHermes: "Updating Stellarium…",
  ...
  pluginsPage: {
    ...
    headline:
      "Discover, install, enable, and update Stella plugins (`stella plugins` parity).",
  ...
  achievements: {
    hero: {
      ...
      title: "Stella Achievements",
      subtitle:
        "Collectible Stella badges earned from real session history. Known unfinished achievements are shown as Discovered; Secret achievements stay hidden until the first matching behavior appears.",
      scan_subtitle:
        "Scanning Stella session history. First scan can take 5–10 seconds on large histories.",
    },
    actions: {
      rescan: "Rescan",
    },
    stats: {
      ...
      latest: "Latest",
      latest_hint_empty: "run Stella more",
      none_yet: "None yet",
    },
    state: {
      unlocked: "Unlocked",
    ...
    guide: {
      ...
      secret_body:
        "Secrets hide their exact trigger. Once Stella sees a related signal, the card becomes Discovered and shows its requirement.",
      scan_status_header: "Scan status",
      scan_status_body:
        "Stella is scanning local history once, then cards will appear automatically. Nothing is stuck if this takes a few seconds.",
    ...
    share: {
      ...
      tweet_text: "Just unlocked {tier_part}\"{name}\" in Stellarium ✦",
    },
  },
