...
// The pre-GitHub Nous palette stays available as nous-alt; default is stella
describe('nous-alt is the retired Nous, not the default', () => {
  it('is registered under its own name and leaves stella as the default', () => {
    expect(DEFAULT_SKIN_NAME).toBe('stella')
