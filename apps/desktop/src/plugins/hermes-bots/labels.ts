...
export function displayName(bot: Partial<RosterRow>, meta?: BotMeta | null): string {
  ...
  // "Stella". Annotated active rows carry sourceScoped too, and keying this
  ...
  // never generic "Stella" or a hostname-derived label.
  if (alias) {
  ...
  // that reads like nobody bothered. Present it as Stella (the default agent)
